...
load('~/Dropbox/Research/4_IndividualDifferences/rcaNatScenes/results/data/Live3D_new/BlankChunk/1TrainedTogether/rcaOnOS_bySubjects.mat');
load('~/Dropbox/Research/4_IndividualDifferences/rcaNatScenes/results/data/Live3D_new/BlankChunk/1TrainedTogether/Live3D_newdata4RCA_OS_bySubjects.mat');
for i=1:21
...
if ~exist('2DvsBlankpermutationTestResults.mat','file')
    for nComp = 1:3
        ...
        data2D = csvread(fullfile('~/Dropbox/Research/4_IndividualDifferences/rcaNatScenes/results/data/Live3D_new/StimuliChunk/2TrainedSeparatedly',strcat('2DRC',num2str(nComp),'.csv')));
...
%For 2D
%load the rca w for drawing blank chunk
load('~/Dropbox/Research/4_IndividualDifferences/rcaNatScenes/results/data/Live3D_new/StimuliChunk/2TrainedSeparatedly/bySubject/rcaOnOS_bySubjects.mat');
load('~/Dropbox/Research/4_IndividualDifferences/rcaNatScenes/results/data/Live3D_new/StimuliChunk/2TrainedSeparatedly/bySubject/Live3D_newdata4RCA_OS_bySubjects.mat')
eegCND = dataOut(:,1);
